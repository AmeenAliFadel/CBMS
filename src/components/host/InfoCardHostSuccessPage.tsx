...
export default function InfoCard({ item }: { item: CardItemHostPage }) {
  return (
    <div data-aos="fade-up" className="group relative overflow-hidden rounded-2xl  border-border border-2 bg-white p-8 shadow-[0_10px_30px_rgba(99,102,241,0.08)] backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_14px_38px_rgba(99,102,241,0.12)]">
      <div
