    ...
    return (
        <div className="flex flex-wrap lg:gap-4 gap-2 ">
            {specs.map((spec, index) => (
                <div key={index}
                    className=" w-32 lg:w-45 flex flex-col items-start gap-0.5 border border-[#EAEDFF] rounded-xl px-4 py-3 min-w-22.5 bg-[#F2F3FF] shadow-sm hover:shadow-md hover:border-indigo-200 transition-all duration-200" >
