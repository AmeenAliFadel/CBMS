...
export function getCarDetailsErrorMessage(error: unknown): string {
    const defaultMessage = "An unexpected error occurred while fetching car details.";
    ...
    if (status === 403) {
        return "You do not have permission to access this car.";
    }
