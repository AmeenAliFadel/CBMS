...
function SearshSection() {
    return (
        <div className="px-10  lg:px-[100px] py-6 lg:py-10">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-4 lg:gap-0">
                ...
                {/* Search */}
                <div className="flex gap-3 items-center px-4 py-3 lg:py-[18px] w-full   lg:w-[572px] border border-border-search rounded-xl focus-within:border-black focus-within:border-2">
                ...
                <div className="flex  lg:items-center justify-between gap-3 lg:gap-6">
                    ...
                    <div className=" w-0.5 h-[40px] lg:h-[16px] bg-border-search"></div>
