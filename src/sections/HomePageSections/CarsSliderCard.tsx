...
export default function CarsSliderCard({
    ...
    return (
        <div data-aos="fade-up" className="w-full bg-white border border-[#E2E7FF] rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
