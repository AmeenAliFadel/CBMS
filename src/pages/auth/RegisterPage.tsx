...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-15">
        ...
        <div className="w-full md:w-1/2 p-9 flex flex-col">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor='full-name' className='text-sm font-semibold text-text-primary pl-2'>
                Full Name
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor='confirm-password' className='text-sm font-semibold text-text-primary pl-2'>
                Confirm Password
              </label>
              <div className="relative">
                <input
