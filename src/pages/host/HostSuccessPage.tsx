      ...
      <div className="flex w-full max-w-6xl flex-col items-center">
        ...
        <section className="mt-10 text-center sm:mt-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-text-primary sm:text-[15px]">
            Thanks for applying to become a host. We&apos;re currently detailing
            your request to ensure everything meets our premium standards.
          </p>
        </section>

        <section className="mt-10 grid w-full gap-4 sm:mt-12 md:grid-cols-3 md:gap-5">
          {cards.map((item) => (
            <InfoCard key={item.title} item={item} />
          ))}
        </section>

        <section className="mt-10 w-full max-w-4xl rounded-2xl border border-border bg-white/75 p-5 shadow-[0_12px_40px_rgba(99,102,241,0.08)] backdrop-blur-sm sm:mt-12 sm:p-8">
        ...
        <section className="mt-10 flex w-full flex-col items-center justify-center gap-4 sm:mt-12 sm:flex-row">
          {/* Dashboard Button */}
